...
tmux split-window -v -t os161:0 # split ttbin/hogparty;e tmux window in half
tmux send-keys -t os161:0.0 'sys161 -w kernel "p uw-testbin/hogparty;q"' C-m # start SYS/161 and wait for GDB to connect
